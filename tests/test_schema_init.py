...
from pipelines.include.src.schema_init import init_warehouse_schema
...
def mock_spark():
    ...
    """
    with patch('pipelines.include.src.schema_init.DatabricksSession') as mock_session:
...
@patch('pipelines.include.src.schema_init.CATALOG', 'test_catalog')
