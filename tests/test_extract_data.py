...
from dags.minio.extract_data import download_kaggle_dataset
...
def test_download_kaggle_dataset_missing_token():
    ...
    with mock.patch.dict(os.environ, {}, clear=True):
        with mock.patch('dags.minio.extract_data.KAGGLE_API_TOKEN', None):
...
def test_download_kaggle_dataset_creates_directory():
    ...
    with mock.patch('dags.minio.extract_data.KAGGLE_API_TOKEN', 'fake-token'), \
         mock.patch('os.path.exists', return_value=False), \
         mock.patch('os.makedirs') as mock_makedirs, \
         mock.patch('kagglehub.dataset_download') as mock_download, \
         mock.patch('dags.minio.extract_data.logger') as mock_logger:
